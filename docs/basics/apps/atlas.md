...
First, you have to install the `atlas-sw-probe` package. To install it go to
_reForis_ menu _Package Management->Packages_ and select _RIPE Atlas SW Probe_.

After that, you have to connect to your router via SSH and start the `atlas` daemon.
...
To form field _Public Key_ copy the key obtained by `get_key` command.

See RIPE Atlas Service Terms and Conditions, if you agree with this, check it and
click to button - Submit your application.
